...
skyward_spine_count = agg_pull_history.count("Skyward Spine")
mistsplitter_reforged_count = agg_pull_history.count("Mistsplitter Reforged")
print(skyward_spine_count / (len(agg_pull_history) - non_5_star_count) * 100, "% of the 5 star pulls were Skyward Spine")
print(mistsplitter_reforged_count / (len(agg_pull_history) - non_5_star_count) * 100, "% of the 5 star pulls were Mistsplitter Reforged")
print(f"In total, {(skyward_spine_count + mistsplitter_reforged_count) / (len(agg_pull_history) - non_5_star_count) * 100} % of the 5 star pulls were featured")
print(f"Overall, {(skyward_spine_count + mistsplitter_reforged_count) / len(agg_pull_history) * 100} % of the pulls were featured")
